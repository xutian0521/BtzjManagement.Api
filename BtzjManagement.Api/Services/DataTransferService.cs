...
namespace BtzjManagement.Api.Services
{
    public class DataTransferService
    {
        ...
        public void ImageMenuInitStructure()
        {
            ...
            v_TableInits.Add(new v_TableInit { columnName = "MENUTYPE", columnTypeAndLimit = "NUMBER(10) not null", columnDesc = "影像类型-一级类型来自SYS_DATA_DICTIONARY表type_key为gjjopttype" });
